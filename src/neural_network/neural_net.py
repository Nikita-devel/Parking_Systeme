...
def load_resources(models_file_path='./models/', file_model='model.h5', file_cascad='haarcascade.xml'):
    ...
    return model, plate_cascade


model, plate_cascade = load_resources()
...
def find_contours(dimensions, img):
    ...
    for cntr in cntrs:
        ...
        if (
                intWidth >= i_width_threshold and intWidth < upper_width and intHeight > lower_height and intHeight < upper_height):
            x_cntr_list.append(
